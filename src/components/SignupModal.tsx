      ...
      <div className="bg-white rounded-xl max-w-md w-full p-6 relative">
        ...
        <div className="text-center mb-6">
          ...
          <h2 className="text-2xl font-bold text-gray-900">
            Get Started with ProduckAI
          </h2>
          <p className="text-gray-600 mt-2">
            Join Product led companies to transform scattered customer feedback
          ...
          <div className="bg-green-50 border border-green-200 rounded-lg p-4 flex items-start gap-3 mb-6">
            ...
            <div>
              ...
              <p className="text-green-700 text-sm mt-1">
                A member of the ProduckAI team will be in touch shortly with
