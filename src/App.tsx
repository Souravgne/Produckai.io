...
function LandingPage() {
  ...
  const features = {
    "pod-spaces": {
      title: "Workspaces",
      description:
        "Create dedicated spaces for your product teams to collaborate on feature decisions.",
      image:
    ...
    "ai-clustering": {
      title: "AI Clustering",
      description:
        "Our AI automatically groups related feedback to reveal patterns and themes.",
      image:
    ...
    "insight-scoring": {
      ...
      description:
        "Prioritize features based on impact, sentiment, and customer value.",
      image:
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="px-4 py-2 bg-white shadow-sm">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center">
            <Logo size="lg" className="w-40 h-40 -mt-4 -mb-4" />{" "}
            {/* Larger logo with negative margins */}
          </div>
          <div className="hidden md:flex items-center space-x-8">
            <a
              href="#features"
              className="text-gray-600 hover:text-[#00A0C1] transition-colors"
            >
              Features
            </a>
            <a
          ...
          <div className="flex flex-col md:flex-row items-center gap-12">
            <div className="md:w-1/2 text-center md:text-left">
              ...
              <h1 className="text-4xl md:text-5xl font-bold mb-6">
                Your <span className="text-purple-600">AI</span> product copilot
                for <span className="text-purple-600">insight-driven</span>{" "}
                roadmaps
              </h1>

              <p className="text-xl text-gray-600 mb-8">
                Surface themes, prioritize features, and align your team — all
                in one space.
              </p>
      ...
      <div className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-gray-600 mb-12 max-w-3xl mx-auto">
            Let <span className="text-purple-600">AI</span> help you make
            confident product decisions backed by data
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-all">
              ...
              <p className="text-gray-600">
                Automatically gather customer feedback from Slack, Zoom, CRM,
                emails, and support tickets into a single source of truth.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-all">
              ...
              <h3 className="text-xl font-semibold mb-3">
                <span className="text-purple-600">AI</span>-Powered Analysis
              </h3>
              <p className="text-gray-600">
                Identify key themes, sentiment, and priorities across all
                customer feedback without manual tagging or sorting.
              </p>
            </div>
            ...
            <div className="bg-white p-8 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-all">
              ...
              <p className="text-gray-600">
                Share insights with cross-functional teams in workspaces to
                align on product priorities and roadmap decisions.
              </p>
            </div>
          </div>
        </div>
      ...
      <div id="features" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-6">
          <h2 className="text-4xl font-bold text-center text-gray-900 mb-4">
            How <span style={{ color: "#00A0C1" }}>Produck</span>
            <span className="text-purple-600">AI</span> works
          </h2>
          <p className="text-xl text-gray-600 text-center mb-12 max-w-3xl mx-auto">
            See how our platform transforms customer feedback into product
            decisions
          </p>
      ...
      <div className="py-20">
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Join the beta today and be among the first to experience the future
