...
DROP POLICY IF EXISTS "insight_themes_access_v3" ON insight_themes;
...
DROP POLICY IF EXISTS "insight_customers_access_v3" ON insight_customers;
...
CREATE POLICY "insights_access_v4"
ON insights
...
CREATE POLICY "insight_themes_access_v4"
ON insight_themes
AS PERMISSIVE FOR ALL
TO authenticated
USING (
...
CREATE POLICY "insight_customers_access_v4"
