...
DROP POLICY IF EXISTS "users_view_profiles_v3" ON user_profiles;
...
DROP POLICY IF EXISTS "insight_themes_access_v2" ON insight_themes;
...
DROP POLICY IF EXISTS "insight_customers_access_v2" ON insight_customers;
...
CREATE POLICY "pod_members_access_v4"
ON pod_members
...
CREATE POLICY "insights_access_v3"
ON insights
AS PERMISSIVE FOR ALL
TO authenticated
USING (
...
CREATE POLICY "insight_themes_access_v3"
ON insight_themes
AS PERMISSIVE FOR ALL
TO authenticated
USING (
...
CREATE POLICY "insight_customers_access_v3"
...
CREATE POLICY "pod_insights_access_v3"
ON pod_insights
AS PERMISSIVE FOR ALL
TO authenticated
USING (
...
CREATE POLICY "pod_invitations_access_v3"
ON pod_invitations
AS PERMISSIVE FOR ALL
TO authenticated
USING (
...
CREATE POLICY "users_view_profiles_v4"
ON user_profiles
