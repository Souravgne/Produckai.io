...
DROP POLICY IF EXISTS "pod_members_access_v6" ON pod_members;
DROP POLICY IF EXISTS "insights_access_v5" ON insights;
DROP POLICY IF EXISTS "insight_themes_access_v4" ON insight_themes;
DROP POLICY IF EXISTS "insight_customers_access_v4" ON insight_customers;

-- Create maximally simplified pod_members policy
CREATE POLICY "pod_members_access_v7"
ON pod_members
...
CREATE POLICY "insights_access_v6"
ON insights
AS PERMISSIVE FOR ALL
TO authenticated
USING (
...
CREATE POLICY "insight_themes_access_v5"
ON insight_themes
AS PERMISSIVE FOR ALL
TO authenticated
USING (
...
CREATE POLICY "insight_customers_access_v5"
