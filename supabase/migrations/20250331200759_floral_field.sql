...
DROP POLICY IF EXISTS "insights_access_final_v6" ON insights;
DROP POLICY IF EXISTS "insight_themes_access_final_v6" ON insight_themes;
DROP POLICY IF EXISTS "insight_customers_access_final_v6" ON insight_customers;

-- Create maximally simplified insights policy
CREATE POLICY "insights_access_final_v7"
ON insights
...
CREATE POLICY "insight_themes_access_final_v7"
ON insight_themes
AS PERMISSIVE FOR ALL
TO authenticated
USING (
...
CREATE POLICY "insight_customers_access_final_v7"
