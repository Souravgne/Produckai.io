...
DROP POLICY IF EXISTS "insights_access_v11" ON insights;
DROP POLICY IF EXISTS "insight_themes_access_v10" ON insight_themes;
DROP POLICY IF EXISTS "insight_customers_access_v10" ON insight_customers;
